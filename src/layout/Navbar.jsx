...
export default function Navbar({ className, buttonType }) {
    ...
    return (
        <>
            <Container>
                <nav className={`${className ?? ""} w-full pt-6 py-10 lg:py-12 lg:pb-6 flex items-center justify-between`}>
                    <figure>
                        <Link to="/">
                    ...
                    <div className="lg:hidden">
                        <svg onClick={openHandler} width="19" height="14" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg">
